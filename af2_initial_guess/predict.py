...
parser.add_argument("-model_dir", 
                    type=str, 
                    default=os.path.join(os.path.dirname(os.path.realpath(__file__)),'model_weights'),
                    help='directory containing model weights (default: model_weights)')
...
class AF2_runner():
    ...
    def __init__(self, args, struct_manager):
        ...
        # modify to push params_dir to args
